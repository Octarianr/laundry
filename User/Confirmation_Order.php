  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Konfirmasi Pemesanan Anda</li>
      </ol>
      <!-- Icon Cards-->
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-cutlery"></i> Konfirmasi Pemesanan Anda </div>
        <div class="card-body">
...
<div class="row col-lg-12">
    ...
    <div class="card col-lg-6" style="padding: 0px">
        <div class="card-header">
          <i class="fa fa-"></i> Rincian Tagihan</div>
        <div class="card-body">
        <form action="" method="POST" enctype="multipart/form-data">
          <div class="row">
             <div class="col-lg-12">
