    ...
    <div class="container-fluid">
      ...
      <div class=" card card-login mx-auto mt-8">
        <div class="card-header">
          <i class="fa fa-cutlery"></i> Form Pemesanan </div>
       ...
       <form action="" method="POST">
           ...
           <div class="form-group col-lg-12">   
              <div class="col-lg-12"> 
                 <label for="exampleInputEmail1">Pilih Jenis Menu</label>
              ...
              <div class="form-group col-lg-12">
                <label for="exampleInputEmail1">Harga cuci Kering (<?php echo $Data->Dry_Price; ?> Rs)</label>
            ...
            <?php }?>
              ...
              <div class="form-group col-lg-12">
                <label for="exampleInputEmail1">Harga Cuci Laundry</label>
            ...
            <?php }?>
              ...
              <div class="form-group col-lg-12">
                ...
                <select class="form-control" required  name="total_Order"  id="Menu_Type" >
                    <option value="" hidden="">Total Pesanan</option>
                    <?php for($a=1;$a<=12;$a++){?>
