    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="card-header">
          <i class="fa fa-cutlery"></i> Form Pemesanan 
          ...
          <div class="row">
           ...
           <div class="form-group col-lg-12">   
            <div id="Mor_Eve"></div>
              ...
              <div class="form-group col-lg-12">
                <label for="exampleInputEmail1">Harga Kering(<?php echo $Data->Dry_Price; ?> Rs)</label>
            ...
            <?php if($Data->Laundry_Price>0){?>
              <div class="form-group col-lg-12">
                <label for="exampleInputEmail1"> Harga Laundry (<?php echo $Data->Laundry_Price; ?> Rs)</label>
