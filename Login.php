...
<html>
<head>
  <title>Laundry Widya ! Login</title>
      ...
      <div class="modal-content">
        ...
        Username dan Kata Sandi salah
          ...
          <form  role="form" method="post" action=""> 
            ...
            <div class="form-group">
              <label for="psw"><span class="glyphicon glyphicon-eye-open"></span> Nomor Telepon</label>
        ...
        <div class="modal-footer">
          <p>Bukan member? <a href="Registration.php">Daftar baru</a></p>
