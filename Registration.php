...
<html>
<head>
  <title>Laundry Widya ! Pendaftaran</title>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form  role="form" method="post" action=""> 
            <div class="form-group">
             ...
             <div class="form-group">
             <label for="psw"><span class="glyphicon glyphicon-user"></span> Nama Ayah</label>
              <input type="text" class="form-control" name="fname" required="" placeholder="Enter Father Name">
            </div>

             <div class="form-group">
             <label for="psw"><span class="glyphicon glyphicon-phone"></span>Nomor Telepon</label>
        ...
        <div class="modal-footer">
          <p><a href="index.php">Situs web utama</a></p>
